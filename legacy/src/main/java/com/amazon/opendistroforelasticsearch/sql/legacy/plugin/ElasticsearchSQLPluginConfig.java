...
import com.amazon.opendistroforelasticsearch.sql.elasticsearch.function.ElasticsearchScalarFunctions;
...
public class ElasticsearchSQLPluginConfig {
  ...
  public StorageEngine storageEngine() {
    ElasticsearchScalarFunctions.register(functionRepository); //TODO
