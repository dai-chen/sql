...
public class QueryFunctionsTest {
    ...
    private static final String FROM_ACCOUNTS = "FROM elasticsearch-sql_test_index_account/account";
    private static final String FROM_NESTED = "FROM elasticsearch-sql_test_index_nested_type/nestedType";
    private static final String FROM_PHRASE = "FROM elasticsearch-sql_test_index_phrase/phrase";
