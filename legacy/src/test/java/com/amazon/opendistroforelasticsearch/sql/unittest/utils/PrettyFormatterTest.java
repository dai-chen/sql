...
public class PrettyFormatterTest {
    ...
    public void assertFormatterOutputsPrettyJson() throws IOException {
        ...
        String explainFormattedOnelineFilePath = getResourceFilePath(
                "/src/test/resources/expectedOutput/explain_format_oneline.json");
    ...
    private static String getResourceFilePath(String relPath) { //TODO: duplicated as TestUtils.getResourceFilePath() in integ-test module
